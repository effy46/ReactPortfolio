    ...
    constructor(model) {
        _defineProperty(this, "render", () => {
            for (var ii = 0; ii < this.views.length; ++ii) {
                if (window.CP.shouldStopExecution(3)) break; if (window.CP.shouldStopExecution(0)) break;
            ...
            () => {
                ...
                for (var ii = 0; ii < this.views.length; ++ii) {
                    if (window.CP.shouldStopExecution(4)) break; if (window.CP.shouldStopExecution(1)) break;
                    var view = this.views[ii];
                    var camera = view.camera;
                    camera.aspect = this.w / this.h;
